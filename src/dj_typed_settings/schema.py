"""
Generated by scripts/generate_schema.py on 2026-02-14 09:08:58
...
class SettingsSchema(BaseSchema):
    ...
    * Receive x-headers
    ...
    """
    LOCALE_PATHS: list | tuple = field(default_factory=list)
    ...
    """
    TEMPLATES: list[dict[str, Any]] | tuple[dict[str, Any], ...] = field(default_factory=list)
    ...
    * Note that these format strings are different from the ones to display dates
    ...
    """
    AUTH_PASSWORD_VALIDATORS: list[dict[str, Any]] | tuple[dict[str, Any], ...] = field(default_factory=list)
    ...
    """
    FIXTURE_DIRS: list | tuple = field(default_factory=list)
    r"""
    The list of directories to search for fixtures
    """
    STATICFILES_DIRS: list[str] | tuple[str, ...] = field(default_factory=list)
    r"""
